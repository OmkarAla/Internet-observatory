...
This project is indexed by GitNexus as **Internet-observatory** (739 symbols, 1869 relationships, 28 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/Internet-observatory/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Internet-observatory/clusters` | All functional areas |
| `gitnexus://repo/Internet-observatory/processes` | All execution flows |
| `gitnexus://repo/Internet-observatory/process/{name}` | Step-by-step execution trace |
